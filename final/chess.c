...
int gin_compare_internal(chessboard cb1, chessboard cb2)
{
  ...
  // chessboard *t_cb1= truncate_fen(cb1);
  // chessboard *t_cb2= truncate_fen(cb2);
  int res= strcmp(cb1.fen, cb2.fen);
  // if(strlen(t_cb1->fen)==1 || strlen(t_cb2->fen)==1)
  // {
  //   res=0;
  // }
  if(res > 0)
